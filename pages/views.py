        ...
        context.update(
            {
                ...
                "subtitle": "About us",
                "description": (
                    "This is an about page Online Store is a web application "
                    "developed as an academic project using the Django framework."
                ),
...
class CartView(View):
    ...
    def get(self, request):
        ...
        products = {}
        products[2] = {"name": "Tv samsung", "price": "1000"}
        products[1] = {"name": "iphone", "price": "2000"}
